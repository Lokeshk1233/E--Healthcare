...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li>  <a href='location map/bihar.html'>bihar</a></li>
       <li> <a href="location map/dhaka">dhaka</a></li>
      <li>  <a href="location map/khulna.html">Khulna</a></li>
     <li>   <a href='location map/punjab.html'>punjab</a></li>
     <li>   <a href='location map/dwarka.html'>dwarka</a></li>
     <li>   <a href='location map/rangpur.html'>Rangpur</a></li>
     <li>   <a href='location map/silong.html'>silong</a></li>
        </ul>
        </li>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        ...
        <i class="fa fa-phone" style="width:30px"></i> Phone: +91 8287425...<br>
